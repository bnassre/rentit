...
if(!this.mousedover&&this.shown)this.hide()},click:function(e){this.hide()
e.stopPropagation()
e.preventDefault()
this.select()
this.$element.focus()
this.hide()},mouseenter:function(e){this.mousedover=true
